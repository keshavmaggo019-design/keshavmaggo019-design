<h1 align="center">Hi there, I'm Keshav Maggo 👋</h1>
<h3 align="center">From Code to Insight | BCA Undergrad | AI/ML Enthusiast | Web Developer</h3>

<p align="center">
  <a href="https://www.linkedin.com/in/keshav-maggo-6b0852271/"><img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" /></a>
</p>
...
- 🎓 BCA undergrad at **IMS Ghaziabad** (Aug 2025 – Aug 2028)
- 🧠 Active member of the **AIML Club**, also working as Emcee & content specialist for the club
- 💻 Building skills in **Java, Python, DSA, AI/ML, and full-stack web development**
- 🌐 Passionate about **smart systems**, practical problem-solving, and shipping real projects
- 📊 Currently deepening my data skills — Excel, SQL, Python & data visualization
- 🌱 Learning to build tech projects end-to-end and sharing the journey in public
- 💼 Shortlisted as a **Web Development Intern** at Axlero Solutions
- 📫 Open to networking, collaboration, and opportunities that support growth
...
**[🚌 Divine Yatra Travels](https://lnkd.in/gUjK8a-g)**
A responsive frontend website for browsing pilgrimage tour packages across India — inspired by my family's bus travel business. Built with HTML5, CSS3, and vanilla JavaScript, with a clean, modern, mobile-friendly UI.

*Planned next: booking functionality, search & filter, backend integration.*

---

### 📜 Certifications

- 🔐 AI and Cybersecurity Awareness — **AI for All** (TCS iON, in partnership with MPIT–CoE & TCS Foundation)
- 📊 Data Science Fundamentals — **HCL GUVI**
- 📡 Internet of Things (IoT) — **E&ICT Academy, IIT Kanpur** (MeitY initiative)
- 📈 30-Day Data Analytics Program — **Novitech**
